...
import TagsList from "@site/src/ILLATheme/TagList"
...
function BlogTagsPostsPageContent({ tags, tag, items, sidebar, listMetadata }) {
  return (
    <BlogLayout howSidebarBanner={false} sidebar={sidebar}>
      <div
        className={clsx(
          "py-8",
          "blog-md:py-16",
      ...
      >
        ...
        <div className={clsx("pt-0 blog-md:pt-16")}>
          <div className="text-gray-500 dark:text-white-04">
            <Translate id="theme.blog.posts_tagged_with">
              Posts tagged with
            </Translate>
          </div>
        ...
        <div className="blog-md:border-t border-t-gray-200 dark:border-t-white-09">
          <BlogListPaginator
